...
void update()
{
    ...
    while (delta_time >= FIXED_TIMESTEP) {
        ...
        if (g_is_colliding_bottom == false && g_current_scene->m_state.player->m_collided_bottom) {
    ...
    g_view_matrix = glm::translate(g_view_matrix, g_effects->m_view_matrix_offset);
