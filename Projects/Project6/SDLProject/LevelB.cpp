...
unsigned int LevelB_DATA[] =
{
    ...
    29,  0,  0,  0,  0,  0, 29, 29,  0, 29,  0,  0,  0, 29,  0, 29, 29, 29, 29,
    29, 29, 29, 29,  0,  0,  0,  0,  0,  0,  0, 29, 29, 29,  0,  0,  0,  0,  0,
    29,  0, 29,  0,  0, 29, 29, 29, 29,  0, 29, 29,  0,  0,  0, 29, 29, 29, 29,
    29, 29, 29,  0, 29, 29,  0,  0,  0,  0,  0,  0,  0, 29,  0, 29, 29, 29, 29,
    29,  0,  0,  0,  0,  0,  0,  0, 29, 29, 29, 29, 29, 29,  0, 29,  0, 29, 29,
    29, 29, 29, 29, 29, 29, 29,  0, 29, 29, 29, 29, 29, 29,  0,  0,  0,  0,  0,
    29, 29, 29, 29, 29, 29, 29,  0, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29
};
...
void LevelB::initialise()
{
    ...
    m_state.enemies[2].set_position(glm::vec3(10.0f, -2.0f, 0.0f));

    // ENEMY 4
    m_state.enemies[3].set_ai_type(GUARD);
    m_state.enemies[3].set_ai_state(IDLE);
    m_state.enemies[3].set_position(glm::vec3(16.0f, -2.0f, 0.0f));
...
void LevelB::update(float delta_time)
{
    ...
    if (m_state.player->get_position().x >= 18.0f) m_state.next_scene_id = 3;
