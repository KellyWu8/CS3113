...
unsigned int LEVELA_DATA[] =
{
    ...
    122,   0,   0,   0,   0,   0, 122, 122,   0, 122,   0,   0,   0, 122,   0, 122, 122, 122, 122,
    122, 122, 122, 122,   0,   0,   0,   0,   0,   0,   0, 122, 122, 122,   0,   0,   0,   0,   0,
    122,   0, 122,   0,   0, 122, 122, 122, 122,   0, 122, 122,   0,   0,   0, 122, 122, 122, 122,
    122, 122, 122,   0, 122, 122,   0,   0,   0,   0,   0,   0,   0, 122,   0, 122, 122, 122, 122,
    122,   0,   0,   0,   0,   0,   0,   0, 122, 122, 122, 122, 122, 122,   0, 122,   0, 122, 122,
    122, 122, 122, 122, 122, 122, 122,   0, 122, 122, 122, 122, 122, 122,   0,   0,   0,   0,   0,
    122, 122, 122, 122, 122, 122, 122,   0, 122, 122, 122, 122, 122, 122, 122, 122, 122, 122, 122
};
...
void LevelA::initialise()
{
    ...
    m_state.enemies[0].m_initial_position = glm::vec3(1.0f, -5.0f, 0.0f);
    m_state.enemies[0].m_left_boundary_offset = 0.0f;
    m_state.enemies[0].m_right_boundary_offset = 4.0f;

    // ENEMY 2
    m_state.enemies[1].set_ai_type(WALKER);
    m_state.enemies[1].set_position(glm::vec3(5.0f, -2.0f, 0.0f));
    m_state.enemies[1].m_initial_position = glm::vec3(5.0f, -2.0f, 0.0f);
    m_state.enemies[1].m_left_boundary_offset = 0.0f;
    m_state.enemies[1].m_right_boundary_offset = 3.0f;
    ...
    m_state.enemies[3].m_initial_position = glm::vec3(15.0f, -2.0f, 0.0f);
    m_state.enemies[3].m_left_boundary_offset = 0.0f;
    m_state.enemies[3].m_right_boundary_offset = 2.0f;
...
void LevelA::update(float delta_time)
{
    ...
    if (m_state.player->get_position().x >= 18.0f) m_state.next_scene_id = 2;
